...
### NEW: Automatically sorts genetic maps by chromosome and position to prevent mis-ordered interpolation. Adds robust handling for missing or unsorted genetic maps for aDNA workflows. Improved numerical interpolation stability for low-density or ancient reference maps. Optional message output summarizing number of positions interpolated and skipped.
